    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-teal-900 p-6 flex flex-col items-center">
      <div className="max-w-4xl mx-auto w-full">
        <header className="mb-10 text-center">
          <h1 className="text-3xl font-bold text-white mb-2">SmartFlow Admin Dashboard</h1>
          <p className="text-teal-200">Manage water leak reports and resources efficiently</p>
        </header>
