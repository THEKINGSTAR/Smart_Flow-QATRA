    ...
    <Card className={earned ? "border-primary-500" : "opacity-70"}>
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          ...
          <div className={`h-10 w-10 rounded-full flex items-center justify-center ${earned ? 'bg-primary-100 text-primary-600' : 'bg-neutral-100 text-neutral-400'}`}>
      ...
      <CardContent>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span>Progress</span>
            <span>{progress} / {achievement.pointsRequired} points</span>
          </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex items-center mb-4 md:mb-0">
                  <div className="h-16 w-16 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center mr-4">
                    <span className="text-xl font-bold font-heading">{user.username.substring(0, 2).toUpperCase()}</span>
                  </div>
                  <div>
        ...
        {!user && (
          <div className="mt-10 text-center">
            <p className="text-neutral-600 mb-4">
              Sign in to track your achievements and earn points
            </p>
            <a 
              href="/auth" 
