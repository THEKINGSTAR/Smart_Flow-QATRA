...
export default function AdminDashboard() {
  ...
  const resolvedPercentage = data ? Math.round((data.resolvedReports / (data.totalReports || 1)) * 100) : 0

  const pendingPercentage = data ? Math.round((data.pendingReports / (data.totalReports || 1)) * 100) : 0

  const criticalPercentage = data ? Math.round((data.criticalReports / (data.totalReports || 1)) * 100) : 0
    ...
    <AdminLayout>
      <div className="flex items-center justify-between space-y-2 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Overview of your water leak management system</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Leak Reports</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-3 h-1 w-full bg-green-100 rounded-full overflow-hidden">
              <div className="bg-green-600 h-full" style={{ width: `${resolvedPercentage}%` }}></div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-3 h-1 w-full bg-amber-100 rounded-full overflow-hidden">
              <div className="bg-amber-600 h-full" style={{ width: `${pendingPercentage}%` }}></div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{criticalPercentage}% of total reports</p>
            <div className="mt-3 h-1 w-full bg-red-100 rounded-full overflow-hidden">
              <div className="bg-red-600 h-full" style={{ width: `${criticalPercentage}%` }}></div>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-6">
        <Card className="col-span-2">
          <CardHeader>
            ...
            <CardDescription>Overview of the latest water leak reports submitted by users</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
                  ...
                  <div key={report.id} className="flex items-start space-x-4 p-3 border rounded-md">
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-medium">{report.title || `Leak Report #${report.id}`}</p>
                        <div
              ...
              <div className="py-10 text-center text-muted-foreground">No reports available</div>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Overview of your managed resources</CardDescription>
          </CardHeader>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card className="col-span-2">
          <CardHeader>
            ...
            <CardDescription>Reports grouped by geographic zones</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Leak report status changes over time</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] flex items-center justify-center border rounded-md">
              <div className="text-center text-muted-foreground">
