      ...
      case "critical":
        return (
          <Badge variant="destructive" className="bg-error-500">
            <span className="animate-pulse mr-1">•</span> Critical
          </Badge>
        )
      case "moderate":
        return (
          <Badge variant="default" className="bg-warning-500 text-white">
            <span className="mr-1">•</span> Moderate
          </Badge>
        )
      case "minor":
        return (
          <Badge variant="default" className="bg-primary-500">
            <span className="mr-1">•</span> Minor
          </Badge>
        )
      default:
    ...
    <Card className="absolute left-4 top-4 max-w-xs w-full bg-white rounded-lg shadow-lg overflow-hidden">
      <CardContent className="p-4">
        ...
        <div className="mt-4 flex gap-2">
          <Button className="flex-1 inline-flex justify-center items-center" onClick={openDirections}>
            <i className="ri-direction-line mr-1"></i> Directions
          </Button>

          <Button variant="outline" className="flex-1 inline-flex justify-center items-center" onClick={shareReport}>
