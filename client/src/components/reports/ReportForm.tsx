        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className={`flex items-center justify-center w-6 h-6 ${step >= 1 ? 'bg-primary-600' : 'bg-neutral-300'} rounded-full text-white`}>
                <span className="text-xs">1</span>
              </div>
              <div className={`h-1 w-8 ${step >= 2 ? 'bg-primary-600' : 'bg-neutral-300'}`}></div>
              <div className={`flex items-center justify-center w-6 h-6 ${step >= 2 ? 'bg-primary-600' : 'bg-neutral-300'} rounded-full text-white`}>
                <span className="text-xs">2</span>
              </div>
              <div className={`h-1 w-8 ${step >= 3 ? 'bg-primary-600' : 'bg-neutral-300'}`}></div>
              <div className={`flex items-center justify-center w-6 h-6 ${step >= 3 ? 'bg-primary-600' : 'bg-neutral-300'} rounded-full ${step >= 3 ? 'text-white' : 'text-neutral-600'}`}>
                  ...
                  <div className="flex">
                    <FormControl>
                      <Input
                        ...
                        className={position ? "bg-neutral-50" : ""}
                      />
                    </FormControl>
                    <Button 
                      type="button" 
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {photos.map((photo, index) => (
                  <div key={index} className="relative h-20 w-20 rounded-md overflow-hidden border border-neutral-300">
                    <img
                      src={photo}
                      alt={`Uploaded leak photo ${index + 1}`}
            ...
            <div>
              ...
              >
                <div className="flex items-center justify-center">
                  ...
                  <span>{isRecording ? "Stop Recording" : voiceNote ? "Re-record Voice Description" : "Record Voice Description"}</span>
                </div>
              </Button>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-neutral-50 p-4 rounded-lg">
              ...
              <div className="text-sm mt-2">
                <p><span className="font-medium">Location:</span> {form.getValues("address")}</p>
                <p><span className="font-medium">Severity:</span> {form.getValues("severity")}</p>
                <p><span className="font-medium">Description:</span> {form.getValues("description")}</p>
                <p><span className="font-medium">Photos:</span> {photos.length} attached</p>
                {voiceNote && <p><span className="font-medium">Voice Note:</span> Included</p>}
              </div>
            </div>
                  ...
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your name won't be associated with this report
                      </p>
                    </div>
                    <FormControl>
                      <Switch
              ...
              <p className="text-sm text-neutral-500 mb-2">
                {user ? (
                  ...
                  <>
                    ...
                    <a href="/auth" className="text-primary-600 ml-1">Sign in</a> to track your reports.
                  </>
                )}
              </p>
            </div>
